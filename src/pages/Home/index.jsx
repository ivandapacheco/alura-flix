...
//       <h2 className={`text-center fw-bold p-2 ${styles['bg-grana']}`} >Jugadores del FC Barcelona</h2>
//       <div className="text-end  pe-3">

//         <button type="button" className={`btn btn-sm  fw-bold ${styles['btn-add']}`}onClick={handleAddPlayer}>
...
//           <PlayerCategory key={position} position={position} players={players} editPlayer={editPlayer} deletePlayer={deletePlayer} />
//         ))
//       ) : (
